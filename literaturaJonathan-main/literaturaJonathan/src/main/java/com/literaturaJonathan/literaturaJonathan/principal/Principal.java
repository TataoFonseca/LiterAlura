package com.literaturaJonathan.literaturaJonathan.principal;

import com.literaturaJonathan.literaturaJonathan.models.*;
...
import com.literaturaJonathan.literaturaJonathan.service.ConsumoApi;
import com.literaturaJonathan.literaturaJonathan.service.ConversorDeDatos;
...
public class Principal {
        ...
        while (opc != 0) {
            ...
            switch (opc) {
                ...
                case 0 -> {
                    ...
                    System.out.println("Gracias por usar literaturaJonathan");
                }
    ...
    private void listaAutoresVivosEnAño() {
        System.out.println("Ingrese el año para el cual desea buscar autores vivos");
        try {
